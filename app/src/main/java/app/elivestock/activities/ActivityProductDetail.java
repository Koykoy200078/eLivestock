...
import static app.elivestock.utilities.Utils.PERMISSIONS_REQUEST;
...
public class ActivityProductDetail extends AppCompatActivity {
    ...
    long product_id;
    TextView txt_product_name, txt_product_price, txt_product_quantity, txt_product_owner, txt_product_owner_contact, txt_product_owner_address;
    WebView txt_product_description;
    ImageView img_product_image;
    Button btn_cart;
    double resp_tax;
    String resp_currency_code;
    private String product_name, product_image, category_name, product_status, currency_code, product_description, product_owner, product_owner_contact, product_owner_address;
    ...
    public void getData() {
        ...
        product_owner = intent.getStringExtra("product_owner");
        product_owner_contact = intent.getStringExtra("product_owner_contact");
        product_owner_address = intent.getStringExtra("product_owner_address");
    ...
    public void initComponent() {
        ...
        txt_product_owner = findViewById(R.id.product_owner);
        txt_product_owner_contact = findViewById(R.id.product_owner_contact);
        txt_product_owner_address = findViewById(R.id.product_owner_address);
    ...
    public void displayData() {
        ...
        txt_product_owner.setText(product_owner);
        txt_product_owner_contact.setText(product_owner_contact);
        txt_product_owner_address.setText(product_owner_address);
    ...
    private void makeJsonObjectRequest() {
        JsonObjectRequest jsonObjReq = new JsonObjectRequest(Request.Method.GET, GET_TAX_CURRENCY, null, response -> {
