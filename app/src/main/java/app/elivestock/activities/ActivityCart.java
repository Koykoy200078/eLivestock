...
import app.elivestock.adapters.AdapterCart;
...
public class ActivityCart extends AppCompatActivity {
    ...
    public class getDataTask extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void result) {
            ...
            String _price = String.format(Locale.ENGLISH, "%1$,.0f", total_price);
            String _tax = String.format(Locale.ENGLISH, "%1$,.0f", str_tax);
